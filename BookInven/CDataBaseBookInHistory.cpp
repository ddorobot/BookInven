...
int CDataBaseBookInHistory::GetBookInfo(const std::string isbn, BookInfo *bookinfo)
{
	int ret = 1;
...
bool CDataBaseBookInHistory::CheckData(const BookInfo bookinfo)
{
...
//Set
void CDataBaseBookInHistory::AddBookInfo(const BookInfo bookinfo)
{
	sqlite3* pDB = NULL;
...
DB_BookInfo CDataBaseBookInHistory::GetLastInfo(void)
{
...
bool CDataBaseBookInHistory::CheckDataSameValue(const BookInfo bookinfo)
{
...
void CDataBaseBookInHistory::Print(void)
{
